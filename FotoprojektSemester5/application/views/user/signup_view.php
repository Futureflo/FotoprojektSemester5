		...
		<div class="row">
			<ul class="nav nav-pills" role="tablist">
				<li class="nav-item"><a class="nav-link active" href="#kunde"
					role="button" data-toggle="collapse" data-target="#fotograf">Kunde</a></li>
				<li class="nav-item"><a class="nav-link" href="#fotograf" role="tab"
					data-toggle="collapse">Fotograf</a></li>
			</ul>
			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="collapse" id="fotograf">
					<form>
						<br>
