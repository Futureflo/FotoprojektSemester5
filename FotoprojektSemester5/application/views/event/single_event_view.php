<div style="visibility: hidden;" id="shoppingCartInsertURL"><?php echo base_url(); ?>Shoppingcart/insert</div>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="container">
					<div class="row">
						<?php echo form_open('/', 'id="addToCartForm"'); ?>
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">	
							<div class="col-md-3 col-sm-2 col-xs-2"><p>Art:<p/></div>		
							<div class="col-md-9 col-sm-10 col-xs-10">		
								<div class="form-group">
									<select class="form-control" id="beschreibungSelect" name="beschreibungSelect">
									</select>
								</div>
							</div>
						</div>	
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<input type="submit" name="In den Warenkorb" value="In den Warenkorb" class="btn btn-success" />
						</div>
