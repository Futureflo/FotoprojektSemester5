	...
	<section class="text-justify">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>
					<strong>§1 Geltung gegenüber Unternehmern und Begriffsdefinitionen</strong><br /> <br />
					(1) Die nachfolgenden Allgemeinen Geschäftbedingungen gelten für alle Lieferungen zwischen uns 
					und einem Verbraucher in ihrer zum Zeitpunkt der Bestellung gültigen Fassung.<br /><br />
					...
					<p>					
					<strong>§2 Zustandekommen eines Vertrages, Speicherung des Vertragstextes</strong><br /><br />
					(1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren 
					Internetshop http://www.snap-gallery.de .<br /><br />
					<strong>(2) Im Falle des Vertragsschlusses kommt der Vertrag mit<br /><br />
					FPS5<br />
					Klaus Muster<br />
					...
					zustande.</strong><br /><br />
					(3) Die Präsentation der Waren in unserem Internetshop stellen kein rechtlich bindendes Vertragsangebot 
					unsererseits dar, sondern sind nur eine unverbindliche Aufforderunge an den Verbraucher, Waren zu bestellen. 
					Mit der Bestellung der gewünschten Ware gibt der Verbraucher ein für ihn verbindliches Angebot auf Abschluss 
					eines Kaufvertrages ab.<br /><br />
					(4) Bei Eingang einer Bestellung in unserem Internetshop gelten folgende Regelungen: Der Verbraucher gibt 
					ein bindendes Vertragsangebot ab, indem er die in unserem Internetshop vorgesehene Bestellprozedur erfolgreich 
					durchläuft.<br /><br />
					...
					den Bestellvorgang abbrechen. Wir bestätigen den Eingang der Bestellung unmittelbar durch eine automatisch generierte 
					E-Mail („Auftragsbestätigung“). Mit dieser nehmen wir Ihr Angebot an.<br /><br /> 
					(5) Speicherung des Vertragstextes bei Bestellungen über unseren Internetshop: Wir speichern den Vertragstext und senden 
					Ihnen die Bestelldaten und unsere AGB per E-Mail zu. Die AGB können Sie jederzeit auch unter 
					http://www.snap-gallery.de/termsandconditions/ einsehen.
					<br /><br />
					</p>
					<p>
					<strong>§3 Preise, Versandkosten, Zahlung, Fälligkeit</strong><br /><br />
					(1) Die angegebenen Preise enthalten die gesetzliche Umsatzsteuer und sonstige Preisbestandteile. Hinzu kommen etwaige 
					Versandkosten.<br /><br />
					(2) Der Verbraucher hat die Möglichkeit der Zahlung per Vorkasse, Nachnahme, PayPal.<br /><br />					
					...
					<p>
					<strong>§4 Lieferung</strong><br /><br />
					(1) Sofern wir dies in der Produktbeschreibung nicht deutlich anders angegeben haben, sind alle von uns angebotenen 
					Artikel sofort versandfertig. Die Lieferung erfolgt hier spätesten innerhalb von 5 Werktagen. Dabei beginnt die Frist 
					für die Lieferung im Falle der Zahlung per Vorkasse am Tag nach Zahlungsauftrag an die mit der Überweisung beauftragte 
					Bank und bei allen anderen Zahlungsarten am Tag nach Vertragsschluss zu laufen. Fällt das Fristende auf einen Samstag, 
					Sonntag oder gesetzlichen Feiertag am Lieferort, so endet die Frist am nächsten Werktag.<br /><br />
					...
					<p>
					<strong>§5 Eigentumsvorbehalt</strong><br /><br />
					...
					****************************************************************************************************<br />
					...
					Tätigkeit zugerechnet werden können:<br /><br /> 
					...
					****************************************************************************************************
					...
					<p>
					<strong>§7 Widerrufsformular<br />Muster-Widerrufsformular</strong><br />
					...
					<p>
					<strong>§9 Vertragssprache</strong><br /><br />
