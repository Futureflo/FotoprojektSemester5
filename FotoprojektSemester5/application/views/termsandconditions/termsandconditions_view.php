<section class="jumbotron text-xs-center">
	<div class="container">
		<h1 class="jumbotron-heading">Allgemeine Geschäfts&shy;bedingungen</h1>
	</div>
</section>
...
<section class="text-justify">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<p>
					<strong>§1 Geltung gegenüber Unternehmern und Begriffsdefinitionen</strong><br />
					<br /> (1) Die nachfolgenden Allgemeinen Geschäftbedingungen gelten
					für alle Lieferungen zwischen uns und einem Verbraucher in ihrer
					zum Zeitpunkt der Bestellung gültigen Fassung.<br />
					<br /> Verbraucher ist jede natürliche Person, die ein
					...
					zugerechnet werden können (§ 13 BGB). <br />
					<br />
				</p>
				<p>
					<strong>§2 Zustandekommen eines Vertrages, Speicherung des
						Vertragstextes</strong><br />
					<br /> (1) Die folgenden Regelungen über den Vertragsabschluss
					gelten für Bestellungen über unseren Internetshop
					...
					<br /> (3) Die Präsentation der Waren in unserem Internetshop
					stellen kein rechtlich bindendes Vertragsangebot unsererseits dar,
					sondern sind nur eine unverbindliche Aufforderunge an den
					Verbraucher, Waren zu bestellen. Mit der Bestellung der gewünschten
					Ware gibt der Verbraucher ein für ihn verbindliches Angebot auf
					Abschluss eines Kaufvertrages ab.<br />
					<br /> (4) Bei Eingang einer Bestellung in unserem Internetshop
					...
					<br /> Die Bestellung erfolgt in folgenden Schritten:<br />
					<br /> 1) Auswahl der gewünschten Ware<br /> 2) Bestätigen durch
					Anklicken der Buttons „Bestellen“<br /> 3) Prüfung der Angaben im
					Warenkorb<br /> 4) Betätigung des Buttons „zur Kasse“ <br /> 5)
					Anmeldung im Internetshop nach Registrierung und Eingabe der
					Anmelderangaben (E-Mail-Adresse und Passwort).<br /> 6) Nochmalige
					Prüfung bzw. Berichtigung der jeweiligen eingegebenen Daten.<br />
					7) Verbindliche Absendung der Bestellung durch Anklicken des
					Buttons „kostenpflichtig bestellen“ bzw. „kaufen“<br />
					<br /> Der Verbraucher kann vor dem verbindlichen Absenden der
					Bestellung durch Betätigen der in dem von ihm verwendeten
					Internet-Browser enthaltenen „Zurück“-Taste nach Kontrolle seiner
				...
				<p>
					<strong>§3 Preise, Versandkosten, Zahlung, Fälligkeit</strong><br />
					<br /> (1) Die angegebenen Preise enthalten die gesetzliche
					Umsatzsteuer und sonstige Preisbestandteile. Hinzu kommen etwaige
					Versandkosten.<br />
					<br /> (2) Der Verbraucher hat die Möglichkeit der Zahlung per
					Vorkasse, Nachnahme, PayPal.<br />
					<br /> (3) Hat der Verbraucher die Zahlung per Vorkasse gewählt, so
					verpflichtet er sich, den Kaufpreis unverzüglich nach
					Vertragsschluss zu zahlen.<br /> Soweit wir per Nachnahme liefern,
					tritt die Fälligkeit der Kaufpreisforderung mit Erhalt der Ware
					ein. <br />
					<br />
				</p>
				<p>
					<strong>§4 Lieferung</strong><br />
					<br /> (1) Sofern wir dies in der Produktbeschreibung nicht
					deutlich anders angegeben haben, sind alle von uns angebotenen
					Artikel sofort versandfertig. Die Lieferung erfolgt hier spätesten
					innerhalb von 5 Werktagen. Dabei beginnt die Frist für die
					Lieferung im Falle der Zahlung per Vorkasse am Tag nach
					Zahlungsauftrag an die mit der Überweisung beauftragte Bank und bei
					allen anderen Zahlungsarten am Tag nach Vertragsschluss zu laufen.
					Fällt das Fristende auf einen Samstag, Sonntag oder gesetzlichen
					Feiertag am Lieferort, so endet die Frist am nächsten Werktag.<br />
				...
				<p>
					...
					<br /> Wir behalten uns das Eigentum an der Ware bis zur
					vollständigen Bezahlung des Kaufpreises vor.<br />
					<br />
				</p>
				<p>
					<strong>§6 Widerrufsrecht des Kunden als Verbraucher<br />Widerrufsrecht
						für Verbraucher
					</strong><br />
					<br /> Verbrauchern steht ein Widerrufsrecht nachfolgender Maßgabe
					zu, wobei Verbraucher jede natürliche Person ist, die ein
					Rechtsgeschäft zu Zwecken abschließt, die überwiegend weder ihrer
					gewerblichen noch ihrer selbständigen beruflichen Tätigkeit
					zugerechnet werden können:<br />
					<br /> <strong>Widerrufsbelehrung</strong><br />
					...
					<br /> <strong>Widerrufsfolgen</strong><br />
					<br /> Wenn Sie diesen Vertrag widerrufen, haben wir Ihnen alle
					...
					wegen dieser Rückzahlung Entgelte berechnet.<br />
					...
					Dienstleistungen entspricht.<br />
				...
				<p>
					...
					<br /> __________________<br /> Name des/der Verbraucher(s)<br />
					<br /> ______________________________________________<br />
					...
					<br /> __________________<br /> Datum<br />
					<br /> __________________<br />
					<br /> (*) Unzutreffendes streichen. <br />
					<br />
				</p>
				<p>
					<strong>§8 Gewährleistung</strong><br />
					<br /> Es gelten die gesetzlichen Gewährleistungsregelungen. <br />
					<br />
				</p>
				<p>
					<strong>§9 Vertragssprache</strong><br />
					<br /> Als Vertragssprache steht ausschließlich Deutsch zur
					Verfügung.<br />
					<br />
				</p>
				<p>
					<strong>§10 Kundendienst</strong><br />
					<br /> <strong>Unser Kundendienst für Fragen, Reklamationen und
