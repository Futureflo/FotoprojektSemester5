<section class="section-white" style="padding-top: 15px;">
	...
	<div id="carousel-example-generic" class="carousel slide float-md-left"
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<img
					src="http://haarentferner.net/wp-content/uploads/2015/01/Frau-Bart.jpg"
					 class="bild">
			</div>
			<div class="carousel-item">
				<img
					src="http://www.kleinwalsertal.com/fotos/kleinwalsertal/taeler/wildental/wildental_01.jpg"
					alt="..."  class="bild">
...
<script type="text/javascript">
	function setPics(){
		var w = (window.innerWidth/100)*99;
		var h = (w/100)*30;
