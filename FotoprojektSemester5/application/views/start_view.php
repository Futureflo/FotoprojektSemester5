...
<div class="container">
	<div class="row">
		<div class="col-md-10 offset-md-1 col-xs-10 offset-xs-1">
			<input type="text" id="searchTerm" class="form-control" onkeyup=""
...
<div class="container">
	<h1 class="display-4 text-xs-center">Events</h1>
</div>
	...
	<div class="row">
		<div class="col-md-10 offset-md-1">
			<div id="carousel-a" class="carousel slide carousel-sync"
				data-ride="carousel" data-pause="false" style="width: 910px">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="http://placehold.it/300x200/1abc9c/fff"> <img
							src="http://placehold.it/300x200/2ecc71/fff"> <img
							src="http://placehold.it/300x200/3498db/fff">
					</div>
					<div class="carousel-item">
						<img src="http://placehold.it/300x200/1abc9c/fff"> <img
							src="http://placehold.it/300x200/2ecc71/fff"> <img
				...
				<a class="left carousel-control" href="#carousel-a"
					data-slide="prev"> <span class="glyphicon glyphicon-chevron-left"></span>
				</a> <a class="right carousel-control" href="#carousel-a"
