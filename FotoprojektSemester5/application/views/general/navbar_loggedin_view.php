...
<!-- 		<li class="nav-item"><a class="nav-link" 
			...
			<div class="float-md-right">
				...
				<!-- <li><p class="nav-item nav-link">Hallo <?php echo $this->session->userdata('uname'); ?></p></li>  -->

				<li class="nav-item active "><a class="active" href="<?php echo base_url(); ?>user/logout"><button type="button"
						class="nav-link btn btn-primary btn-md">Abmelden</button></a></li>
			</div>
