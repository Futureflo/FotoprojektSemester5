...
<nav class="navbar navbar-fixed-top navbar-dark bg-inverse">
	...
	<div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar">
		...
		<ul class="nav navbar-nav">
			...
			<li class="nav-item dropdown" aria-labelledby="exCollapsingNavbar"><a
				class="nav-link dropdown-toggle" href="http://example.com"
				id="supNportedContentDropdown" data-toggle="dropdown"
				aria-haspopup="true" aria-expanded="false">Admin</a>
				<div class="dropdown-menu"
					aria-labelledby="supportedContentDropdown">
					<a class="dropdown-item" href="<?php echo base_url();?>admin/">Dashboard</a>
					<a class="dropdown-item"
						href="<?php echo base_url();?>admin/users/">Alle Benutzer</a> <a
						class="dropdown-item" href="<?php echo base_url();?>admin/events/">Alle
			...
			<div class="float-md-right">
				...
				<li class="nav-item active "><button type="button" id="login-btn"
...
<!-- Modal -->
<div id="loginModal" class="modal-md fade modal" tabindex="-1"
	...
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			...
			<div class="modal-body">        
					...
					placeholder="E-Mail-Adresse eingeben" id="user_email"
					name="user_email" value="<?php  echo set_value('user_email'); ?>" />
				<span align="center" id="email_span" class="text-danger"
					style="display: none">Das Feld darf nicht leer sein!</span> </br> <input
					type="password" class="form-control input-sm chat-input"
					placeholder="Passwort eingeben" id="user_password"
					name="user_password"
					value="<?php  echo set_value('user_password'); ?>" /> <span
					align="center" id="password_span" class="text-danger"
					style="display: none">Das Feld darf nicht leer sein!</span> </br>
				<div class="container">
					<div class="row">
						<div class="col-md-6 offset-md-3">
							<div class="login-btn-wrapper">
								<span class="group-btn">
									<button onclick="validate()" id="login" name="submit"
										type="submit" class="btn btn-primary btn-md btn-block">Login</button>
								</span>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 offset-md-2">
							<a href="<?php echo base_url();?>Login/forgotPassword/">Passwort
								vergessen?</a>
						</div>
					</div>
				</div>
				<?php  echo form_close(); ?>
				<div>
					<span align="center" id="fehler_span" class="text-danger"><?php  echo $this->session->flashdata('msg'); ?></span>
				</div>
					...
					<div class="row">
						<div class="col-md-8 offset-md-2">
							<button name="submit" type="submit"
								class="btn btn-success btn-md btn-block">Registrieren</button>
						</div>
					</div>
				</div>
			</div>
