...
echo base_url ();
					?>admin/users/">Alle
						Benutzer</a> <a class="dropdown-item" href="<?php
						
echo base_url ();
						?>admin/events/">Alle Events</a> <a class="dropdown-item"
						href="<?php
...
echo base_url ();
					?>user/">Benutzereinstellungen</a> <a class="dropdown-item"
						href="<?php
...
echo base_url ();
						?>event/">Neues Event</a> <a class="dropdown-item"
							href="<?php
...
echo set_value ( 'user_email' );
					...
					style="display: none">Das Feld darf nicht leer sein!</span> </br> <input type="password" class="form-control input-sm chat-input"
					placeholder="Passwort eingeben" id="user_password" name="user_password" value="<?php
					
echo set_value ( 'user_password' );
					?>" /> <span
					align="center" id="password_span" class="text-danger" style="display: none">Das Feld darf nicht leer sein!</span> </br>
				<div class="container">
					<div class="row">
