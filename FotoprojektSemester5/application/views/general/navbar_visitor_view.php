...
<nav class="navbar navbar-fixed-top navbar-dark bg-inverse">
	<button class="navbar-toggler hidden-sm-up pull-right" type="button" data-toggle="collapse" data-target="#exCollapsingNavbar" aria-controls="exCollapsingNavbar" aria-expanded="false" aria-label="Toggle navigation"></button>
...
echo base_url ();
							?>event/aFqS/">Einzelnes Event</a> <a
...
$attributes = array (
					...
					?>
		                    ...
		                    <input type="text" class="form-control input-sm chat-input" placeholder="E-Mail-Adresse eingeben" id="user_email" name="user_email" value="<?php
...
echo set_value ( 'user_email' );
		                    ...
		                    <input type="password" class="form-control input-sm chat-input" placeholder="Passwort eingeben" id="user_password" name="user_password" value="<?php
